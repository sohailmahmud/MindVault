...
void main() {
  group('AIDataSourceImpl Tests', () {
    ...
    final testDocument1 = DocumentModel(
      ...
      content:
          'This is a document about Flutter development and Dart programming',
    ...
    group('calculateSimilarity', () {
      test('should return 1.0 for identical embeddings', () async {
        ...
        final similarity =
            await aiDataSource.calculateSimilarity(embedding, embedding);
      ...
      test('should return 0.0 for zero embeddings', () async {
        ...
        final similarity = await aiDataSource.calculateSimilarity(
            zeroEmbedding, normalEmbedding);
    ...
    group('performSemanticSearch', () {
      test('should return empty list when no documents provided', () async {
        ...
        final results =
            await aiDataSource.performSemanticSearch(query, emptyDocuments);
      ...
      test('should return documents sorted by similarity', () async {
        ...
        final results =
            await aiDataSource.performSemanticSearch(query, documents);
    ...
    group('suggestCategories', () {
      test('should suggest Work category for work-related content', () async {
        const content =
            'This is about a meeting with clients and project deadlines';
      ...
      test(
          'should suggest multiple categories when content matches multiple keywords',
          () async {
        const content =
            'Meeting about machine learning project with the development team';
      ...
      test('should limit suggestions to maximum of 3', () async {
        const content =
            'Meeting about machine learning project with the development team for education and health finance travel ideas';
      ...
      test('should return empty list for content without matching keywords',
          () async {
    ...
    group('extractTags', () {
      ...
      test('should extract importance tags', () async {
        const content =
            'This is an important and urgent task that needs attention';
      ...
      test('should extract meeting tags', () async {
        const content =
            'Meeting scheduled for discussion about project progress';
      ...
      test('should limit tags to maximum of 5', () async {
        const content =
            'Flutter Dart React JavaScript Python Java Swift Kotlin important urgent todo meeting "test phrase"';
    ...
    group('generateSummary', () {
      test(
          'should return original content if length is less than 150 characters',
          () async {
      ...
      test('should generate summary for long content', () async {
        const longContent =
            'This is the first sentence. This is the second sentence. This is the third sentence. This is the fourth sentence with lots of additional text to make it longer than 150 characters total.';
      ...
      test('should not exceed maximum length', () async {
        final longContent =
            'This is a very long document. ' * 20; // Much longer than 150 chars

        final summary = await aiDataSource.generateSummary(longContent);

        expect(summary.length,
            lessThanOrEqualTo(160)); // Some tolerance for sentence completion
      });
    });

    group('findSimilarDocuments', () {
      test('should return empty list when no similar documents found',
          () async {
        ...
        final similarTitles = await aiDataSource.findSimilarDocuments(
      ...
      test('should find similar documents based on content', () async {
        final similarDocument = DocumentModel(
          ...
          content:
              'More about Flutter development and Dart programming concepts',
          category: 'Development',
      ...
      test('should limit results to maximum of 5 documents', () async {
        final manyDocuments = List.generate(
            10,
            (index) => DocumentModel(
                  id: index + 10,
