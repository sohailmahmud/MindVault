...
void main() {
  group('Dependency Injection Container Tests', () {
    ...
    test('can register and retrieve basic dependencies', () {
      ...
      serviceLocator
          .registerFactory<int>(() => DateTime.now().millisecondsSinceEpoch);
    ...
    test('can handle dependency chains', () {
      ...
      serviceLocator.registerLazySingleton<int>(
          () => serviceLocator.get<String>().length);
    ...
    test('initializeDependencies completes without error', () async {
      ...
      await expectLater(
        ...
        skip:
            'Requires platform-specific setup for ObjectBox and path_provider');
    ...
    test('supports named instances', () {
      serviceLocator.registerLazySingleton<String>(() => 'instance1',
          instanceName: 'first');
      serviceLocator.registerLazySingleton<String>(() => 'instance2',
          instanceName: 'second');

      expect(serviceLocator.get<String>(instanceName: 'first'),
          equals('instance1'));
      expect(serviceLocator.get<String>(instanceName: 'second'),
          equals('instance2'));
      expect(serviceLocator.get<String>(instanceName: 'first'),
